...
\title{MATH 621 Fall 2017 Homework \#4}
...
\hardsubproblem{Prove $B(\alpha, \beta) = \frac{\Gammaf{\alpha}\Gammaf{\beta}}{\Gammaf{\alpha+\beta}}$. Using the method from class (i.e. the textbook) is not required.}\spc{13}
