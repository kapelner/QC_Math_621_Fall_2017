...
\title{MATH 621 Fall 2017 Homework \#1 INCOMPLETE}
...
\intermediatesubproblem{Let $X \sim \poisson{\lambda}$ independent of $Y \sim \poisson{\lambda}$. Find an expression for $\prob{X > Y}$ \emph{as best as you are able to answer}.}\spc{6}
