...
\subquestionwithpoints{7} Let $\Xoneton \iid \binomial{n_0}{p}$ and let $\X$ denote the vector of these r.v.'s. Is $\X \sim \multinomial{n}{\p}$? If yes, find the values of its parameters as functions of $n_0$ and $p$. If no, explain why not. \spc{10}
